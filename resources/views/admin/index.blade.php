...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset ('core/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css')}}" rel="stylesheet" type="text/css" />
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset ('core/images/logo.png')}}" alt="" height="24"> <span class="logo-txt">Jatinan Kafe</span>
                                </span>
                            </a>
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © Jatinan Kopi.
                            </div>
                            <div class="col-sm-6">
