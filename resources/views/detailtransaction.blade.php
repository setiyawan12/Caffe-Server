                        ...
                        <div class="card-body">
                            ...
                            <div class="d-print-none mt-3">
                                <div class="float-end">
                                    ...
                                    <a href="javascript: void(0)" class="btn btn-primary w-md waves-effect waves-light"
                                        id="btn-checkout">CHECKOUT</a>
                                    @elseif($dt->status == "SELESAI")
                                    <a href="#" class="btn btn-primary w-md waves-effect waves-light disabled">CHECKOUT
                                        COMPLETED</a>
